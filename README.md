...
* [GIT](#git)
  * [FAQ](#faq)
  * <samp title="Syncs the local repo with the remote repo./n  A better method would be to work with `git fetch` which executes `git pull -p` and `git merge` in a single command.  `-p`, i think, is for `prune` ">git pull</samp>
